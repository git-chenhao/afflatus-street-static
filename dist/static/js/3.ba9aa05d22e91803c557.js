...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_element_ui_packages_upload_src_upload_dragger_vue__ = __webpack_require__(172);
    ...
    onSubmit: function onSubmit() {
      ...
      this.$http.post(url, params).then(function (data) {
        if (data.body.responseCode == 1000) {
          ...
          this.status = 'success';
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__static_js_util_js__["d" /* setCookie */])('avatar', this.userInfo.avatar, 7);
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__static_js_util_js__["d" /* setCookie */])('nickName', this.userInfo.nickName, 7);
          window.setTimeout(function () {
...
var update = __webpack_require__(92)("44a4ac9e", content, true);
