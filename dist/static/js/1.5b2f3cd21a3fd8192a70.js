...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_wangeditor__ = __webpack_require__(151);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_vue__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__static_js_util_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__node_modules_element_ui_packages_form_src_form_item_vue__ = __webpack_require__(101);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__node_modules_element_ui_packages_button_src_button_vue__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__node_modules_element_ui_packages_button_src_button_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__node_modules_element_ui_packages_button_src_button_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__node_modules_element_ui_packages_form_src_form_vue__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__node_modules_element_ui_packages_form_src_form_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__node_modules_element_ui_packages_form_src_form_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ElForm: __WEBPACK_IMPORTED_MODULE_5__node_modules_element_ui_packages_form_src_form_vue___default.a,
    ElButton: __WEBPACK_IMPORTED_MODULE_4__node_modules_element_ui_packages_button_src_button_vue___default.a,
  ...
  data: function data() {
    return {
      ...
      clickSave: false,
      opusInfo: '',
      opusId: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__static_js_util_js__["d" /* getUrlKey */])('opusId'),
      labelInfoList: [],
      labelIdList: [],
      editor: '',
      opusListInDraft: '',
  ...
  methods: {
    init: function init() {
      var url = __WEBPACK_IMPORTED_MODULE_1__config_vue___default.a.host + '/v1/as/lable/all';
    ...
    switchOpus: function switchOpus(opusId, dustbin) {
      this.dustbin = dustbin;
      this.opusId = opusId;
      this.loadingOpusInfo();
      history.pushState(null, '', '/editor?opusId=' + opusId);
    },
    loadingOpusInfo: function loadingOpusInfo() {
      var url = __WEBPACK_IMPORTED_MODULE_1__config_vue___default.a.host + '/v1/as/opus/detail/' + this.opusId;
    ...
    timingSave: function timingSave() {
      //10s保存一次
      var _self = this;
    ...
    getOpusList: function getOpusList(state) {
      var url = __WEBPACK_IMPORTED_MODULE_1__config_vue___default.a.host + '/v1/as/opus/list/state/' + state + '/page/1';
      this.$http.get(url).then(function (data) {
        console.log(data);
        if (data.body.responseCode == 1000) {
          if (state == -1) {
    ...
    saveOpus: function saveOpus(state, notifyMessage) {
      /**
       * 只验证发布状态
       */
      if (state == 3) {
      ...
      var url = __WEBPACK_IMPORTED_MODULE_1__config_vue___default.a.host + '/v1/as/opus/save';
      var params = {
    ...
    deleteOpus: function deleteOpus() {
      var _this = this;
  ...
  mounted: function mounted() {
    ...
    var editor = new __WEBPACK_IMPORTED_MODULE_0_wangeditor___default.a('#editorElem');
    editor.customConfig.onchange = function (html) {
      _this2.editorContent = html;
    };
    this.nickName = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__static_js_util_js__["b" /* getCookie */])('nickName');
    this.avatar = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__static_js_util_js__["b" /* getCookie */])('avatar');
    this.userId = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__static_js_util_js__["b" /* getCookie */])('userId');
    editor.customConfig.withCredentials = true;
    editor.customConfig.uploadFileName = 'file';
    editor.customConfig.uploadImgServer = __WEBPACK_IMPORTED_MODULE_1__config_vue___default.a.host + '/v1/common/upload/batch';
    editor.create();
    this.editor = editor;
    this.init();
  }
...
// module
exports.push([module.i, "nav .logo[data-v-264c2d66]{float:left;height:56px;padding:7px 8px 8px}a[data-v-264c2d66],body[data-v-264c2d66]{color:#333;text-decoration:none;overflow-x:hidden}.title[data-v-264c2d66]{padding:5px}.nav-title[data-v-264c2d66]{cursor:pointer;width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.nav-title-select[data-v-264c2d66]{color:#ea6f5a}", ""]);
...
var update = __webpack_require__(86)("fec9f532", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [(_vm.opusListInDraft.length == 0) ? _c('p', {
    staticStyle: {
      "color": "#7f868e"
    }
  }, [_c('i', {
    staticClass: "fa fa-inbox"
  }), _vm._v(" 当前无数据\n                  ")]) : _vm._e(), _vm._v(" "), _vm._l((_vm.opusListInDraft), function(item) {
    return _c('span', [(item.id == _vm.opusId) ? _c('span', [_c('p', {
      staticClass: "nav-title nav-title-select",
      on: {
        "click": function($event) {
          _vm.switchOpus(item.id, false)
        }
      }
    }, [_c('i', {
  ...
  })], 2)], 2), _vm._v(" "), _c('el-collapse-item', {
    attrs: {
      "name": "2"
    }
  }, [_c('template', {
    ...
    staticClass: "fa fa-trash"
  }), _vm._v(" 垃圾箱\n                ")]), _vm._v(" "), (_vm.opusListInDustbin.length == 0) ? _c('p', {
    staticStyle: {
      "color": "#7f868e"
    }
  }, [_c('i', {
  ...
  }, _vm._l((_vm.opusListInDustbin), function(item) {
    return _c('span', [(item.id == _vm.opusId) ? _c('span', [_c('p', {
      staticClass: "nav-title nav-title-select",
      on: {
        "click": function($event) {
          _vm.switchOpus(item.id, true)
        }
      }
    }, [_c('i', {
      staticClass: "fa fa-trash",
      on: {
        "click": _vm.deleteOpus
      }
    }), _vm._v("\n                     " + _vm._s(item.title) + "\n                  ")])]) : _c('span', [_c('p', {
      staticClass: "nav-title",
      on: {
    ...
    staticClass: "fa fa-trash"
  }), _vm._v(" 删除")])], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "标签"
    }
  }, [_c('el-select', {
    ...
    model: {
      value: (_vm.labelIdList),
      callback: function($$v) {
        _vm.labelIdList = $$v
      },
      expression: "labelIdList"
    }
  }, _vm._l((_vm.labelInfoList), function(item) {
    return _c('el-option', {
      key: item.id,
      attrs: {
        "label": item.name,
    ...
    staticClass: "fa fa-trash"
  }, [_vm._v(" 删除")])])], 1)], 1)], 1)], 1), _vm._v(" "), _c('br'), _vm._v(" "), _c('div')], 1)], 1)
},staticRenderFns: []}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_async_validator__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_element_ui_src_mixins_emitter__ = __webpack_require__(100);
//
//
//
//
