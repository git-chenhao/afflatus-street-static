...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_vue__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__static_js_util_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_element_ui_packages_upload_src_upload_dragger_vue__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_element_ui_packages_upload_src_upload_dragger_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__node_modules_element_ui_packages_upload_src_upload_dragger_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__node_modules_element_ui_packages_form_src_form_item_vue__ = __webpack_require__(132);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    ElUploadDrag: __WEBPACK_IMPORTED_MODULE_2__node_modules_element_ui_packages_upload_src_upload_dragger_vue___default.a },
  name: 'hello',
  data: function data() {
    return {
      nickName: '',
  ...
  mounted: function mounted() {
    this.nickName = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__static_js_util_js__["b" /* getCookie */])('nickName');
    this.avatar = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__static_js_util_js__["b" /* getCookie */])('avatar');
    this.userId = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__static_js_util_js__["b" /* getCookie */])('userId');
    this.getUserInfo();
  },

  methods: {
    getUserInfo: function getUserInfo() {
      var url = __WEBPACK_IMPORTED_MODULE_0__config_vue___default.a.host + '/v1/uc/info/' + this.userId;
    ...
    clickWechatQrCodeUpload: function clickWechatQrCodeUpload() {
    ...
    uploadAvatar: function uploadAvatar() {
      ...
      var url = __WEBPACK_IMPORTED_MODULE_0__config_vue___default.a.host + '/v1/common/upload/batch';
    ...
    uploadWechatQrCode: function uploadWechatQrCode() {
    ...
    onSubmit: function onSubmit() {
      var url = __WEBPACK_IMPORTED_MODULE_0__config_vue___default.a.host + '/v1/uc/update';
      ...
      this.$http.post(url, params).then(function (data) {
        if (data.body.responseCode == 1000) {
          ...
          this.status = 'success';
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__static_js_util_js__["c" /* setCookie */])('avatar', this.userInfo.avatar, 7);
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__static_js_util_js__["c" /* setCookie */])('nickName', this.userInfo.nickName, 7);
          window.setTimeout(function () {
...
// module
exports.push([module.i, ".maincircular[data-v-123d4080]{width:80px;height:80px;border:1px solid #ddd;border-radius:50%;vertical-align:middle}.wechatQrCode[data-v-123d4080]{width:150px;height:150px}.avatar-uploader .el-upload[data-v-123d4080]{border:1px dashed #d9d9d9;border-radius:6px;cursor:pointer;position:relative;overflow:hidden}.avatar-uploader .el-upload[data-v-123d4080]:hover{border-color:#20a0ff}.avatar-uploader-icon[data-v-123d4080]{font-size:28px;color:#8c939d;width:178px;height:178px;line-height:178px;text-align:center}.avatar[data-v-123d4080]{width:178px;height:178px;display:block}", ""]);
...
var update = __webpack_require__(84)("44a4ac9e", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "click": _vm.clickUpload
    }
  }, [_vm._v("上传"), _c('i', {
    staticClass: "el-icon-upload2 el-icon--right"
  })]), _vm._v(" "), (_vm.avatarUploadPercentage > 0) ? _c('el-progress', {
    staticStyle: {
      "width": "130px"
    },
    attrs: {
      "percentage": _vm.avatarUploadPercentage,
      "status": _vm.avatarUploadStatus
    }
    ...
    model: {
      value: (_vm.userInfo.weiboUrl),
      callback: function($$v) {
        _vm.userInfo.weiboUrl = $$v
      },
      expression: "userInfo.weiboUrl"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "个人介绍"
    ...
    model: {
      value: (_vm.userInfo.personalIntroduction),
      callback: function($$v) {
        _vm.userInfo.personalIntroduction = $$v
      },
      expression: "userInfo.personalIntroduction"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "微信二维码"
    }
  }, [(_vm.userInfo.wechatQrCodeUrl != '' && _vm.userInfo.wechatQrCodeUrl != undefined) ? _c('img', {
    staticClass: "wechatQrCode",
    attrs: {
      "src": _vm.userInfo.wechatQrCodeUrl
    }
    ...
    on: {
      "click": _vm.clickWechatQrCodeUpload
    }
  }, [_vm._v("上传"), _c('i', {
    staticClass: "el-icon-upload2 el-icon--right"
  })]), _vm._v(" "), (_vm.wechatQrCodeUploadPercentage > 0) ? _c('el-progress', {
    staticStyle: {
      "width": "150px"
    },
    attrs: {
      "percentage": _vm.wechatQrCodeUploadPercentage,
      "status": _vm.wechatQrCodeUploadStatus
    }
  ...
  }, [_vm._v("立即修改")])], 1)], 1)], 1), _vm._v(" "), _c('el-col', {
    staticStyle: {
      "text-align": "left"
    },
    attrs: {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_element_ui_src_mixins_emitter__ = __webpack_require__(118);
//
//
//
//
