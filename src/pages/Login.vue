    ...
    <div class="container" v-if="!loginSuccess">
      <section class="content">
        ...
        <span class="input input--hideo">
					<input class="input__field input__field--hideo" disableautocomplete type="text" id="input-41"
                 autocomplete="off" v-model="mobile" placeholder="手机号码"/>
          ...
          <input type="hidden">
          <span class="input input--hideo">
					<input class="input__field input__field--hideo" disableautocomplete type="password" id="input-43"
...
<script>
  ...
  import { setCookie, getUrlKey } from '../../static/js/util.js'
      ...
      login: function () {
        ...
        this.$http.post(url, params).then(function (data) {
          if (data.body.responseCode == 1000) {
            ...
            if (this.jumpUrl == '' || this.jumpUrl == undefined || this.jumpUrl == null) {
              this.jumpUrl = '/home'
            }
